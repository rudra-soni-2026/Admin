        ...
        try {
            ...
            if (data.status === 1 && data.product) {
                ...
                if (apiImages.length > 0) {
                    ...
                    // Update the SPECIFIC variant scanned
                    setVariants(prev => {
                        const nv = [...prev];
                        if (nv[variantIndex]) {
                                ...
                                {variants.map((v, i) => (
                                    <div key={i} className="panel bg-white dark:bg-black/20 border border-gray-200 shadow-sm animate__animated animate__fadeInUp relative overflow-hidden">
                                        <div className="flex items-center justify-between mb-4 bg-gray-50/50 dark:bg-white/5 -m-5 px-5 py-3 border-b border-gray-100">
                                            ...
                                            <button type="button" className="text-danger hover:bg-danger/10 p-1.5 rounded-full transition-colors" onClick={() => setVariants(variants.filter((_, idx) => idx !== i))} disabled={variants.length === 1}>
                                        ...
                                        <div className="upload__image-wrapper">
                                            {imageList.length === 0 ? (
                                                ...
                                                >
                                                    ...
                                                    <p className="text-xs font-bold text-gray-500 uppercase tracking-tighter">Upload Primary Product Image</p>

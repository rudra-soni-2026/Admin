...
const WarehouseManagerList = () => {
    ...
    const fetchData = async (currentPage: number) => {
        try {
            setLoading(true);
            let query = `/management/admin/list?page=${currentPage}&limit=${pageSize}&role=warehouse_manager`;
    ...
    const handleAddWarehouseManager = () => {
...
export default WarehouseManagerList;

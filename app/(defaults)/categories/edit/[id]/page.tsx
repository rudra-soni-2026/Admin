                            ...
                            {formData.level > 0 && (
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input id="bg_color" type="color" className="p-1 border border-gray-200 dark:border-gray-700 w-12 h-10 rounded-lg cursor-pointer bg-white dark:bg-black" value={formData.bg_color} onChange={handleChange} />
                                        <input type="text" className="form-input py-2 text-sm flex-1 uppercase" value={formData.bg_color} onChange={(e) => setFormData({...formData, bg_color: e.target.value})} placeholder="#F4F4F4" />
                                    </div>
                                </div>
                            )}

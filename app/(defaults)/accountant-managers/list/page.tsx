...
const AccountantManagerList = () => {
    ...
    const fetchData = async (currentPage: number) => {
        try {
            setLoading(true);
            let query = `/management/admin/list?page=${currentPage}&limit=${pageSize}&role=account_manager`;
    ...
    return (
        <div>
            <ul className="mb-6 flex space-x-2 rtl:space-x-reverse">
                ...
                <li className="text-gray-500 before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Accountant Manager List</span>
                </li>
            </ul>
...
export default AccountantManagerList;
